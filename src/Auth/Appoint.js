...
const Appoint = () => {
  ...
  return (
    <div>
      ...
      {showConsentModal && (
        <div className="fixed bottom-0 right-0 w-2/3 md:w-1/2 lg:w-1/3 max-w-screen-sm m-6 bg-white p-4 md:p-8 rounded-lg shadow-lg">
          {/* <div className="bg-white p-8 rounded-lg"> */}
            ...
            <button 
              ...
              className="self-end bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mt-4"
            >
                ยอมรับ
            </button>
          {/* </div> */}
