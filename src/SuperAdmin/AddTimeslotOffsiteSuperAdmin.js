...
const AddTimeslotOffsiteSuperAdmin = () => {
    ...
    const handleConfirm = async () => {
        ...
        try {
            const response = await fetch('http://localhost:5000/super-admin-add-timeslotoffsite', {
                method: 'POST',
                headers: {
                    ...
                    <div className="bg-gray-300 rounded shadow-lg p-4 px-4 md:p-6 mb-5 overflow-x-auto">
                        ...
                        <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-2">
                            <div className="text-gray-600">
                                <p className="font-medium text-lg text-black">Offsite's Time Slots</p>
...
export default AddTimeslotOffsiteSuperAdmin;
