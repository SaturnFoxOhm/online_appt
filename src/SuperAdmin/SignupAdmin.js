...
const SignupAdmin = () => {
  ...
  const SignupNewAdmin = async (event) => {
    ...
    if(!AdminIDRegex.test(AdminID) || AdminID.length !== 6){
      alert('AdminID should be 6 digits long and contain only numbers.');
      ...
      return; // Do not proceed with signup
        ...
        alert('Password length should not exceed 20 characters.');
        return; // Do not proceed with signup
    }
        ...
        <div className="bg-yellow-400 lg:w-6/12 md:7/12 w-8/12 shadow-3xl rounded-xl">
          ...
          <form className="pt-12 md:pt-24 pb-12 md:pb-24" onSubmit={SignupNewAdmin}>
            ...
            <div className="flex items-center text-lg mb-6 md:mb-8">
              ...
              <input type="test" id="AdminID" required className="bg-gray-200 rounded pl-12 py-2 md:py-4 focus:outline-none w-full" placeholder="AdminID (Only 6 Numbers)" />
            </div>
            <div className="flex items-center text-lg mb-6 md:mb-8">
            <svg className="absolute ml-3 mt-1" width="24" viewBox="0 0 24 24">
            ...
            <div className="flex items-center text-lg mb-6 md:mb-8">
              ...
              <input type="password" id="passwords" required className="bg-gray-200 rounded pl-12 py-2 md:py-4 focus:outline-none w-full" placeholder="Password (Max 20 Characters)" />
            </div>
