          ...
          <div className="bg-white lg:w-6/12 md:7/12 w-8/12 shadow-3xl rounded-xl">
            ...
            <form className="pt-12 md:pt-24 pb-12 md:pb-24" onSubmit={LoginToServer}>
              <div className="flex items-center text-lg mb-6 md:mb-8">
                ...
                <input type="test" id="AdminID" required className="bg-gray-200 rounded pl-12 py-2 md:py-4 focus:outline-none w-full" placeholder="Username" />
              </div>
              <div className="flex items-center text-lg mb-6 md:mb-8">
              ...
              <div className="text-right mt-4">
                <p className="text-gray-600">Don't have an account? <Link to="/adminsignup" className="text-blue-500">Sign up</Link></p>
              </div>
            </form>      
          </div>
        </div>
